...
//		contract.lastTradeDateOrContractMonth("20221028");
//		contract.conid(584246264);

		ComboLeg leg1 = new ComboLeg();
		ComboLeg leg2 = new ComboLeg();

		List<ComboLeg> addAllLegs = new ArrayList<>();
		leg1.conid(536593700);//150 call AAPL
		leg1.ratio(1);
		leg1.action("SELL");
        leg1.exchange("SMART");
		leg2.conid(539222653);//155 call APPL
...
//		m_s.reqSecDefOptParams(0, "IBM", "",/* "",*/ "STK", 8314);
		///////////////////////////////////////////////////////////////////
//		m_s.reqSecDefOptParams(1, "AAPL", "",/* "",*/ "OPT", 575178395);
      //  m_s.reqTickByTickData(2,combo(),"BidAsk",2,true);
		//	m_s.placeOrder(3923,combo(), OrderSamples.LimitOrder("SELL", Decimal.ONE, 50));


		//order.orderType(OrderType.LMT);

	//	m_s.reqMktData(1,ContractSamples.USOptionContract(),"MIDASK",true,true,null);
		//m_s.placeOrder(6,Tools.bullSpread("TSLA",564054968,561916909), Tools.createOrderSell(-8.4));
//		m_s.placeOrder(121,combo(), OrderSamples.LimitOrder("TSLA", Decimal.ONE, 210));
		Contract contract=new Contract();
		...
		contract.exchange ( "SMART");
		contract.currency("USD");
       m_s.reqContractDetails(1211,contract);
