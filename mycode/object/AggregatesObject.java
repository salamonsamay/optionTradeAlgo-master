...
public class AggregatesObject {
    ...
    public AggregatesObject(String optionsTicker,double vwap, double close_price, long timestamp, double volume, double highest_price, double lowest_price, int number_of_transactions, double open_price) {
