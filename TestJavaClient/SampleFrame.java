...
class SampleFrame extends JFrame implements EWrapper {
    ...
    private void onCancelRealTimeBars() {
        ...
        // cancelSubmittedOrder market data
    ...
    private void onCancelHistoricalData() {
        ...
        // cancelSubmittedOrder historical data
    ...
    private void onCancelAccountSummary() {
        ...
        dlg.setVisible(true);
        if ( dlg.m_rc ) {
            // cancelSubmittedOrder ACCOUNT summary
    ...
    private void onCancelPositionsMulti() {
        ...
        dlg.setVisible(true);
        if ( dlg.m_rc ) {
            // cancelSubmittedOrder positions multi
    ...
    private void onCancelAccountUpdatesMulti() {
        ...
        dlg.setVisible(true);
        if ( dlg.m_rc ) {
            // cancelSubmittedOrder ACCOUNT updates multi
